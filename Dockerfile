...
RUN npm install -g jshint csslint eslint nsp coffeelint stylint sass-lint@1.5.1 jscpd eslint-plugin-react@4.3.0 eslint-config-airbnb eslint-config-hapi
