...
RUN npm install -g eslint@2.10.2 eslint-plugin-import@1.8.0 eslint-plugin-jsx-a11y@1.2.0 eslint-plugin-react@5.1.1 eslint-config-airbnb@9.0.1 \
                   eslint-plugin-hapi@4.0.0 eslint-config-hapi@9.1.0  babel-eslint@6.1.0
RUN npm install -g eslint-config-airbnb eslint-config-ember eslint@^2.9.0 eslint-plugin-jsx-a11y@^1.2.0 eslint-plugin-import@^1.7.0 eslint-plugin-react@^5.0.1 eslint@^3.2.2 eslint-plugin-react@^6.0.0 eslint-plugin-jsx-a11y@^2.0.1 eslint@^2.10.21
