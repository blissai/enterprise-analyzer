...
RUN npm install -g jshint@2.9.2 csslint@0.10.0 eslint@2.8.0 nsp@2.3.1 coffeelint@1.15.7 stylint@1.3.8 https://github.com/founderbliss/sass-lint.git jscpd@0.6.1 eslint-config-airbnb@7.0.0 eslint-config-hapi@9.1.0 typescript tslint@3.8.1
